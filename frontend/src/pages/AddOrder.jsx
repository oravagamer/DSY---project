...
const AddOrder = () => {
    ...
    return (<Section>
            <form ref={formRef}>
                <input type="text" ref={nameRef} required={true} placeholder="Name" />
                <input type="datetime-local" ref={finishDateRef}
                       placeholder="Finish date" required={true} />
                <textarea ref={descriptionRef} placeholder="Description" required={true} />
                ...
                <label htmlFor="file-upload">
                    <div onClick={event => {
                        ...
                        <img src="/upload_foto.svg" alt="upload button" />
                        <div>Select Files</div>
                    </div>
                    <ul>
                        {images.map(
                            (value, index) => (
                                <li key={index}><img datatype={value.type}
                ...
                <input type="file" name="file-upload" ref={imagesRef}
